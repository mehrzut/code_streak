...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i6.AuthRepo>(
        () => _i7.AuthRepoImpl(dataSource: gh<_i5.AuthDataSource>()));
    gh.lazySingleton<_i8.LoginWithGitHub>(
        () => _i8.LoginWithGitHub(repo: gh<_i6.AuthRepo>()));
    gh.factory<_i9.AuthBloc>(() => _i9.AuthBloc(gh<_i8.LoginWithGitHub>()));
    return this;
  }
}
